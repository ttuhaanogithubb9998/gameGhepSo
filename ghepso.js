    ...
    const handleSelectItem = (e) => {
        ...
        if (value == attr.value.nodeValue && index != attr.index.nodeValue) {
            ...
            if (firstElement) {
                ...
                firstElement.parentElement.style.transform = 'rotateX(0deg)';
                firstElement.innerHTML = attr.value.nodeValue;

                //ẩn đi element khi click vào hai element có cùng value
                setTimeout(() => {
                    e.target.parentElement.style.width = '0px';
                    e.target.parentElement.style.margin = '0px';
                    e.target.parentElement.style.padding = '0px';
                    firstElement.parentElement.style.width = '0px';
                    firstElement.parentElement.style.margin = '0px';
                    firstElement.parentElement.style.padding = '0px';
